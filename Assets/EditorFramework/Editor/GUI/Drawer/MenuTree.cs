...
namespace EditorFramework
{
    ...
    {
        public class InnerTree : TreeView
        {
                    ...
                    if (ok)
                    {
                        ...
                        for (int j = 0; j < items.Length; j++)
                        {
                            ...
                            if (exist == null)
                            {
                                ...
                                exist = new Item()
                                {
                                    id = index + _items.Count - 1, depth = depth, displayName = name
                                };
            ...
            {
                var fit = _items.Find(item => item.path == path);
                if (fit != null)
                {
        ...
        private void Fitter(string fit)
        {
